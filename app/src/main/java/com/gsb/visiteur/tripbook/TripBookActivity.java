package com.gsb.visiteur.tripbook;
...
import com.gsb.visiteur.R;
import com.gsb.visiteur.base.BaseActivity;
import com.gsb.visiteur.utils.StorageUtils;
...
public class TripBookActivity extends BaseActivity {
    ...
    private static final String AUTHORITY="com.gsb.visiteur.fileprovider";
